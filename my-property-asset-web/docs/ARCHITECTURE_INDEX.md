...
**Last updated:** 2026-07-16 (P9 Building Management vertical slice implemented — stop; await approval before Units)
...
| **P7** | **Builder Organization Vertical Slice** | 1.0 | **Implemented — approved for P8** | P1–P5, P6A, P6B | **2026-07-16** |
| **P8** | **Builder Project Management Vertical Slice** | 1.0 | **Implemented — approved for P9** | P1–P5, P6A, P6B, P7 | **2026-07-16** |
| **P9** | **Building Management Vertical Slice** | 1.0 | **Implemented — stop; await approval before Units** | P1–P5, P6A–P8 | **2026-07-16** |
...
└── docs/
    ...
    │   ├── P8_Builder_Project_Management_Vertical_Slice.md (Phase P8 — stop before Buildings/Units)
    │   ├── P9_Building_Management_Vertical_Slice.md (Phase P9 — stop before Units)
    │   ├── P9_1_Project_Hierarchy_Enhancement.md (Phase P9.1 — enhance Project/Building; stop before Units)
    │   └── diagrams/
...
- **P9.1 — Project Hierarchy Enhancement** (2026-07-16): Additive `project_hierarchy` on `builder_projects` (BUILDING_BASED | DIRECT_UNITS), type↔hierarchy rules, Farm Land type, navigation/guards hide Buildings for DIRECT_UNITS, building create blocked in service+RPC. Unit inventory types prepared only — **STOP; do not implement Units.** See `docs/architecture/P9_1_Project_Hierarchy_Enhancement.md`.
- **P9 — Building Management Vertical Slice** (2026-07-16): Batch 4 SQL (`builder_buildings` + list/get/create/update/archive RPCs), repository + BuildingService, project-scoped buildings UI with required/optional compatibility by project type, duplicate-code validation, soft archive. **STOP — do not implement Units.** See `docs/architecture/P9_Building_Management_Vertical_Slice.md`.
- **P8 — Builder Project Management Vertical Slice** (2026-07-16): Batch 3 SQL (`builder_projects` + list/get/create/update/archive RPCs), repository + ProjectService, list/create/edit/detail UI with search/filter/sort, live Builder Dashboard project KPIs. **STOP — do not implement Buildings or Units.** See `docs/architecture/P8_Builder_Project_Management_Vertical_Slice.md`.
