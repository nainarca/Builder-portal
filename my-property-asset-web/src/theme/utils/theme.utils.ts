...
export function designTokensToCssVariables(tokens: DesignTokens): CssVariableMap {
  ...
  return {
    ...
    ...(typography.fontSize4xl ? { [`${CSS_VAR_PREFIX}-font-size-4xl`]: typography.fontSize4xl } : {}),
    ...(typography.fontSize5xl ? { [`${CSS_VAR_PREFIX}-font-size-5xl`]: typography.fontSize5xl } : {}),
    ...(typography.fontSize6xl ? { [`${CSS_VAR_PREFIX}-font-size-6xl`]: typography.fontSize6xl } : {}),
